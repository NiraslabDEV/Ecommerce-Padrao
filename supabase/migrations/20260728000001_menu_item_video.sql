-- ============================================================================
-- Suporte a vídeo curto em produtos em destaque (loop mudo, tipo showcase).
-- Reaproveita o bucket storefront-assets (já aceita video/mp4|webm, 50MB) —
-- mesmo padrão da 20260724000002_banner_video_support.sql.
-- ============================================================================
