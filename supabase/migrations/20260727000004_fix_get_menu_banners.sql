-- ============================================================================
-- get_menu(): repõe banners[] (derrubado por engano na 20260727000003).
-- A 20260727000003 dizia ser "puramente aditiva" sobre a 20260721000001, mas
-- essa já era uma versão desatualizada — a 20260724000002 tinha adicionado
-- banners[] (com media_type) depois dela. Resultado: banners sumiu do
-- get_menu() em produção. Esta migration mescla os dois: mantém track_stock/
-- stock_qty (20260727000003) e repõe banners[] (20260724000002).
-- ============================================================================
