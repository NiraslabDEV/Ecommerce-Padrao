-- ============================================================================
-- ECOMMERCE-PADRAO — corrige get_menu(): reintroduz variants[]/addons[]
-- A migration 20260619000001_promo_categories.sql redefiniu get_menu() e,
-- sem intencao, deixou de fora variants/addons que 20260616000001 tinha
-- adicionado. Os swatches de tamanho/cor (PDP) e o facet de variante (PLP)
-- dependem destes campos (ver apps/web/app/(public)/menu/menu-types.ts).
-- Esta migration e puramente aditiva: mantem tudo da versao 0619
-- (promo_banner_url, promo_code, marketing, categoria.photo_url) e devolve
-- variants[]/addons[] por item, no mesmo shape que a 0616 definia.
-- ============================================================================
