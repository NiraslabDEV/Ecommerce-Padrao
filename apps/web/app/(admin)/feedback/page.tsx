...
export default function FeedbackPage() {
  ...
  if (loading && page === 0) {
    return (
      <div className="rounded-2xl border border-white/[0.08] bg-white/[0.04] backdrop-blur-[12px] shadow-[0_4px_24px_rgba(0,0,0,0.4)] p-10 text-center">
        <div className="text-[#EA1D2C]">A carregar feedbacks...</div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      {feedbacks.length === 0 ? (
        <div className="rounded-2xl border border-white/[0.08] bg-white/[0.04] backdrop-blur-[12px] shadow-[0_4px_24px_rgba(0,0,0,0.4)] p-10 text-center">
          <div className="text-[#A8A8B0]">Sem feedbacks ainda</div>
        </div>
      ) : (
            ...
            >
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    {feedback.order_number && (
                      <span className="px-2 py-1 bg-white/[0.08] rounded text-xs text-[#A8A8B0]">
                        {feedback.order_number}
                      </span>
                    )}
                  </div>
                ...
                {feedback.total_cents && (
                  <div className="text-right">
                    <div className="text-[#A8A8B0] text-sm">Valor do Pedido</div>
                    <div className="text-[#EA1D2C] font-bold">
              ...
              {feedback.comment && (
                <div className="pt-3 border-t border-white/[0.04]">
                  <p className="text-[#e8e8ea]">&ldquo;{feedback.comment}&rdquo;</p>
                </div>
              )}
