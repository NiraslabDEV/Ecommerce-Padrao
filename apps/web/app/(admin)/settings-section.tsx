...
export function SettingsSection() {
  ...
  if (!settings) {
    return <p className="text-[#A8A8B0] text-sm">A carregar definições…</p>;
  }
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="border border-white/[0.08] bg-white/[0.04] backdrop-blur-[12px] shadow-[0_4px_24px_rgba(0,0,0,0.4)] rounded-lg p-4">
          <h4 className="text-sm font-semibold text-[#EA1D2C] mb-3">M-Pesa</h4>
          <p className="text-sm text-[#A8A8B0]">Número: {settings.mpesa_number || 'Não definido'}</p>
          <p className="text-sm text-[#A8A8B0]">Nome: {settings.mpesa_name || 'Não definido'}</p>
        </div>

        <div className="border border-white/[0.08] bg-white/[0.04] backdrop-blur-[12px] shadow-[0_4px_24px_rgba(0,0,0,0.4)] rounded-lg p-4">
          <h4 className="text-sm font-semibold text-[#EA1D2C] mb-3">e-Mola</h4>
          <p className="text-sm text-[#A8A8B0]">Número: {settings.emola_number || 'Não definido'}</p>
          <p className="text-sm text-[#A8A8B0]">Nome: {settings.emola_name || 'Não definido'}</p>
        </div>

        <div className="border border-white/[0.08] bg-white/[0.04] backdrop-blur-[12px] shadow-[0_4px_24px_rgba(0,0,0,0.4)] rounded-lg p-4">
          <h4 className="text-sm font-semibold text-[#EA1D2C] mb-3">Morada de Levantamento</h4>
          <p className="text-sm text-[#A8A8B0]">{settings.pickup_address || 'Não definido'}</p>
          {settings.pickup_maps_url && (
            <a href={settings.pickup_maps_url} target="_blank" rel="noopener noreferrer" className="text-sm text-[#EA1D2C] hover:underline">
              Ver no mapa
            </a>
          )}
        </div>
        ...
        <div className="border border-white/[0.08] bg-white/[0.04] backdrop-blur-[12px] shadow-[0_4px_24px_rgba(0,0,0,0.4)] rounded-lg p-4">
          <h4 className="text-sm font-semibold text-[#EA1D2C] mb-3">Horário de Funcionamento</h4>
          <p className="text-sm text-[#A8A8B0]">Abertura: {settings.open_hour}:00</p>
          <p className="text-sm text-[#A8A8B0]">Fecho: {settings.close_hour}:00</p>
          <p className="text-sm text-[#A8A8B0]">Slots de: {settings.slot_minutes} min</p>
        </div>

        <div className="border border-white/[0.08] bg-white/[0.04] backdrop-blur-[12px] shadow-[0_4px_24px_rgba(0,0,0,0.4)] rounded-lg p-4">
          <h4 className="text-sm font-semibold text-[#EA1D2C] mb-3">Estado da Loja</h4>
        ...
        <div className="border border-white/[0.08] bg-white/[0.04] backdrop-blur-[12px] shadow-[0_4px_24px_rgba(0,0,0,0.4)] rounded-lg p-4">
          <h4 className="text-sm font-semibold text-[#EA1D2C] mb-3">Email</h4>
          <p className="text-sm text-[#A8A8B0]">{settings.owner_email || 'Não definido'}</p>
        </div>
      </div>
...
function SettingsModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-[4px] z-50 flex items-center justify-center p-4">
      ...
      >
        <h2 className="font-bold text-lg text-[#EA1D2C]">Editar Definições</h2>

        <div className="space-y-4">
          <div>
            <h3 className="text-sm font-semibold text-[#EA1D2C] mb-2">M-Pesa</h3>
          ...
          <div>
            <h3 className="text-sm font-semibold text-[#EA1D2C] mb-2">e-Mola</h3>
            <div className="space-y-2">
              <input
                value={emolaNumber}
          ...
          <div>
            <h3 className="text-sm font-semibold text-[#EA1D2C] mb-2">Morada de Levantamento</h3>
            <div className="space-y-2">
              <textarea
                value={pickupAddress}
          ...
          <div>
            <h3 className="text-sm font-semibold text-[#EA1D2C] mb-2">Horário</h3>
            <div className="grid grid-cols-2 gap-2">
              <div>
                <label className="block text-xs text-[#A8A8B0] mb-1">Abertura</label>
                <input
                  type="number"
                  min="0"
                  max="23"
              ...
              <div>
                <label className="block text-xs text-[#A8A8B0] mb-1">Fecho</label>
                <input
                  type="number"
                  min="1"
                  max="24"
              ...
              <div className="col-span-2">
                <label className="block text-xs text-[#A8A8B0] mb-1">Slots (minutos)</label>
                <input
                  type="number"
                  min="5"
                  max="120"
          ...
          <div>
            <h3 className="text-sm font-semibold text-[#EA1D2C] mb-2">Estado da Loja</h3>
            <div className="flex items-center gap-2">
              <input
                type="checkbox"
                id="acceptingOrders"
              ...
              />
              <label htmlFor="acceptingOrders" className="text-xs font-semibold text-[#A8A8B0]">
                Aceitar pedidos
              </label>
            </div>
          </div>
          ...
          <div>
            <h3 className="text-sm font-semibold text-[#EA1D2C] mb-2">Email</h3>
            <input
              type="email"
              value={ownerEmail}
