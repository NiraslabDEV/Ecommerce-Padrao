...
export function MarketingSection() {
  ...
  if (loading) {
    return <p className="text-sm text-[#A8A8B0]">A carregar configuração...</p>;
  }
  ...
  return (
    <div className="space-y-8 max-w-3xl">
      ...
      <section className="space-y-4">
        <div>
          <h2 className="text-lg font-semibold text-[#EA1D2C]">IDs de rastreio (públicos)</h2>
        ...
        {PUBLIC_FIELDS.map(({ key, label, placeholder, help, helpUrl }) => (
          <div key={key} className="space-y-1">
            ...
            <a
              ...
              className="text-xs text-[#A8A8B0] hover:text-[#EA1D2C]"
            >
              onde encontrar: {help} ↗
            </a>
          </div>
      ...
      <section className="space-y-4">
        <div>
          <h2 className="text-lg font-semibold text-[#EA1D2C]">Tokens secretos (servidor)</h2>
          <p className="text-sm text-[#A8A8B0]">
      ...
      <section className="space-y-2">
        <h2 className="text-lg font-semibold text-[#EA1D2C]">Preview do dataLayer</h2>
        <pre className="rounded-lg bg-black/30 border border-white/[0.08] px-4 py-3 text-xs text-[#A8A8B0] overflow-x-auto">
          {dataLayerPreview}
        </pre>
      </section>
